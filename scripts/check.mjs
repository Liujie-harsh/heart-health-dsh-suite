...
const expectedKnobs = [
  ...
  'HEART_HEALTH_RAW_TOOL_ANALYZE',
  'HEART_HEALTH_RAW_TOOL_INTERPRET',
  'HEART_HEALTH_RAW_TOOL_REPORT',
  'HEART_HEALTH_RAW_TOOL_COMPARE',
  'HEART_HEALTH_RAW_TOOL_LIST_CASES',
  'HEART_HEALTH_RAW_TOOL_CASE_DETAIL',
  'HEART_HEALTH_RAW_TOOL_LIST_TASKS',
  'HEART_HEALTH_RAW_TOOL_REVIEW_STATUS',
  'HEART_HEALTH_RAW_TOOL_SUBMIT_REVIEW',
